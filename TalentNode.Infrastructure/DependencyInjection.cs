...
namespace TalentNode.Infrastructure
{
    public static class DependencyInjection
    {
        ...
        {
            services.AddDbContext<TalentNodeDbContext>(options => { options.UseSqlServer("Server =148.113.47.114,49884;Database=Jobworld; Userid=jobworld4u; Password=Mahadevshivv!@12;Trusted_Connection=true; Encrypt=true; TrustServerCertificate=true;"); });
